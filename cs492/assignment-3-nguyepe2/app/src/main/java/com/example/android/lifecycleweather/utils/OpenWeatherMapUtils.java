...
public class OpenWeatherMapUtils {
     ...
     */
    private final static String OWM_FORECAST_APPID = "cbc8fb0a4cfc7b006d06aea3515ee4d5";
    ...
    public static String buildForecastURL(String forecastLocation, String temperatureUnits) {
        ...
        Uri.Builder builder = Uri.parse(OWM_FORECAST_BASE_URL).buildUpon();


            builder.appendQueryParameter(OWM_FORECAST_QUERY_PARAM, temperatureUnits);

        if (!temperatureUnits.equals("")) {
            builder.appendQueryParameter(OWM_FORECAST_UNITS_PARAM, forecastLocation);
        }

        return builder.appendQueryParameter(OWM_FORECAST_APPID_PARAM, OWM_FORECAST_APPID).build().toString();
